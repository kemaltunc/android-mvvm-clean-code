...
class ProfileViewHolder(parent: ViewGroup) : BaseViewHolder<BaseModel>(parent, LAYOUT_ID) {
    override fun bindItem(item: BaseModel) {
        Log.d("oldumuacaba", "ProfileViewHolder")


    }

    companion object {
        const val LAYOUT_ID = R.layout.cell_profile_item
    }
}